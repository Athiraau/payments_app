...
//   List<ImpsResponse>? response;
//
//   ImpsTableModel({this.response});
//
//   ImpsTableModel.fromJson(Map<String, dynamic> json) {
//     if (json['response'] != null) {
//       response = <ImpsResponse>[];
//       json['response'].forEach((v) {
//         response!.add(new ImpsResponse.fromJson(v));
//       });
//     }
//   }
//
...
//         this.sEQNO});
//
//   ImpsResponse.fromJson(Map<String, dynamic> json) {
