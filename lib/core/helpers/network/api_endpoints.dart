class ApiEndPoints {
  ...
  static const String baseURL =
      'https://app.manappuram.net/PaymentReportApi/api/Report/';

  static const String portaleURL =
      'https://uatapp.manappuram.net/PortalSessionApi/api/PortalSession/PortalDecrypt';
  ...
  static String p_flag = "";
  static String p_pageval = "";
  static String p_paraval = "";
}
